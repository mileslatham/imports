...
Pandas has fuctions to read data from a variety of different source types, but the the two functions you’re likely to use first are read_csv() and read_excel(). The documentation for each is below: 
